...
> *"Todo grande desenvolvedor já foi um iniciante que não desistiu"* — e eu trabalho duro para entregar código de qualidade.

---

## 🚀 Sobre Mim

Sou um **Desenvolvedor Full Stack** apaixonado por criar soluções web modernas e funcionais. Com foco em **JavaScript** e **TypeScript**, atuo tanto no frontend quanto no backend — transformando ideias em aplicações que funcionam de verdade.
...
✅ Desenvolvimento de interfaces modernas e responsivas com HTML, CSS e JavaScript  
✅ Criação de APIs e serviços backend robustos com Node.js  
